...
class newdivide extends StatelessWidget {
  Widget build(BuildContext context) {
    final assetsAudioPlayer = AssetsAudioPlayer();
    assetsAudioPlayer.open(
      Audio("assets/audio/new.mp3"),
    );
    play() {
      print("Play the song");
                  ...
                  children: <Widget>[
                    ...
                    IconButton(
                      ...
                      onPressed: () => Navigator.push(context,
                          new MaterialPageRoute(builder: (context) => faded())),
                    )
                  ],
                ),
              ),
